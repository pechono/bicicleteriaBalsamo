                ...
                <div class=" bg-white  rounded-lg shadow-md  m-5 h-3/4">
                        <div class="w-full rounded-lg shadow-md m-5 p-4">
                            <div class="flex gap-4 w-full">
                                ...
                                <!-- Columna izquierda - Tipo de Venta -->
                                {{-- <div class="flex-1">
                                    <div class="col-span-6 sm:col-span-4 rounded-lg border shadow-lg p-4">
                                        <div class="text-lg mb-4">Tipo de Venta</div>
                                        <select id="tipo_id" class="block w-full text-1xl rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" 
                                                wire:model='tipo_id' wire:change='tipoVenta()'>
                                            <option value="">Seleccionar...</option>
