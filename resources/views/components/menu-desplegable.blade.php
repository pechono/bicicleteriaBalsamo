    ...
    <nav class="pt-6 space-y-2">
        ...
        <div class="hoverDiv w-full text-green-400">
            ...
            <div id="servicioSubMenu" class="pl-8 hidden text-lg  text-white">
                ...
                <a href="{{ route('service.egresoBici') }}" class="hover:text-xl block py-1 px-4 hover:bg-gray-600">Registro Servicio</a>
        ...
        <div class="hoverDiv w-full text-orange-500">
            <a href="javascript:void(0)" class=" py-2 px-2 hover:bg-gray-700 flex items-center" onclick="toggleSubMenu('operacionSubMenu')">
                <div class="flex justify-between items-center w-full">
                    ...
                    <span class="movableDiv  text-2xl transition-transform duration-300 ease-in-out text-white">Operaciones</span>
                </div>
            </a>
        ...
        <div class="hoverDiv w-full text-gray-500">
                ...
                <a href="javascript:void(0)" class=" py-2 px-2 hover:bg-gray-700 flex items-center" onclick="toggleSubMenu('gestionSubMenu')">
                    <div class="flex justify-between items-center w-full">
                        ...
                        <span class="movableDiv  text-2xl  transition-transform duration-300 ease-in-out text-white">Gestión</span>
                    </div>
                </a>

            <div id="gestionSubMenu" class="pl-2 hidden text-lg  text-white">
                <a href="{{ route('articulo.articuloGrupo') }}" class="hover:text-xl  py-1 px-4 hover:bg-gray-600 flex">
                   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-8 w-8">
        ...
        <div class="hoverDiv w-full text-purple-600 ">
            <a href="javascript:void(0)" class=" py-2 px-2 hover:bg-gray-700 flex items-center" onclick="toggleSubMenu('ofertaSubMenu')">
                <div class="flex justify-between items-center w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 border-purple-600  rounded-xl border-4">
                    ...
                    <span class="movableDiv text-2xl rounded-lg transition-transform duration-300 ease-in-out text-white">Ofertas</span>
                </div>
            </a>
        ...
        <div class="hoverDiv w-full text-red-600 ">
            <a href="javascript:void(0)" class=" py-2 px-2 hover:bg-gray-700 flex items-center" onclick="toggleSubMenu('cierreSubMenu')">
                <div class="flex justify-between items-center w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 border-red-600  rounded-xl border-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                      </svg>

                    <span class="movableDiv text-2xl rounded-lg transition-transform duration-300 ease-in-out text-white">Cierre Caja</span>
                </div>
            </a>
